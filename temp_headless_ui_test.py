...
def main() -> int:
    ...
    try:
        ...
        with sync_playwright() as p:
            ...
            page.screenshot(path=str(ARTIFACTS_DIR / "01_dashboard.png"), full_page=True)
            ...
            page.screenshot(path=str(ARTIFACTS_DIR / "02_accounts.png"), full_page=True)
            ...
            export_page.screenshot(path=str(ARTIFACTS_DIR / "03_export_popup.png"), full_page=True)
            export_page.close()
            ...
            page.screenshot(path=str(ARTIFACTS_DIR / '04_import_dialog.png'), full_page=True)
            ...
            page.screenshot(path=str(ARTIFACTS_DIR / "05_import_toast.png"), full_page=True)
            ...
            page.screenshot(path=str(ARTIFACTS_DIR / "06_apikeys.png"), full_page=True)
